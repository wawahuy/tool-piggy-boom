package com.giayuh_hdr.service;
...
import com.giayuh_hdr.MainApplication;
import com.giayuh_hdr.R;
import com.giayuh_hdr.utils.Util;
...
public class Tun2HttpVpnService extends VpnService {
  ...
  private void start() {
    if (vpn == null) {
      ...
      if (vpn == null)
        throw new IllegalStateException("Không thể kêt nôi đến server!");
  ...
  private Builder getBuilder() {
    ...
    List<String> dnsList = Util.getDefaultDNS(MainApplication.getInstance().getApplicationContext());
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
      ...
      if (app.loadVPNMode() == MainApplication.VPNMode.DISALLOW) {
        Set<String> disallow = app.loadVPNApplication(MainApplication.VPNMode.DISALLOW);
        ...
        Set<String> allow = app.loadVPNApplication(MainApplication.VPNMode.ALLOW);
